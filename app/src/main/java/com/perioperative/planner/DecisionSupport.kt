...
object DecisionSupport {
    ...
    fun analgesia(c:Case):Decision {
        ...
        when(exposure){
            ...
            "Naltrexone"->{refs+="opioidConsensus";actions+="Opioid antagonism can alter response. Obtain a prescriber / acute-pain plan based on formulation and last dose; do not automatically escalate opioids or calculate a conversion."}
        }
